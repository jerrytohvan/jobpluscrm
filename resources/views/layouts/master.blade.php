...
<body class="app">
  ...
  @else
    <div class="container" style="padding-top:5%;">
      <div class="row">
        <div class="col-lg-4 col-md-4 col-xs-4 thumb" style="margin-left: auto; margin-right: auto;">
          <img src="{{ URL::to('img/tanoto-foundation.jpg')}}" class="img-fluid" >
        </div>
      </div>
    </div>
 <!-- SHOW LOGIN PAGE -->
    ...
    @yield('content')
        ...
        <div class="text-center">
          <small>Copyright © Jobplus 2018</small>
        </div>
  @endif
